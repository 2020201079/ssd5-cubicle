function remove_alternate_char(str_given){
    var return_str = "";

    for(var i=0;i<str_given.length;i++){
    
        if( i%2 == 0){
            return_str = return_str + str_given[i];
        }
...
var playing_song ;
var cond = 0;
//var audio1 = new Audio("song1.mp3");
(function(modules) {
	...
	AFRAME.registerComponent("super-keyboard", {
		...
		updateCursorPosition: function() {
			...
			for(var i = 0; i < (this.data.value.length)/2; i++) {
		...
		updateTextInput: function(value) {
            ...
            this.textInputObject.value = remove_alternate_char(this.textInputObject.value);
            this.textInput.setAttribute("text", this.textInputObject)
            
            if( this.textInputObject.value == "song1"){
                var my_song_1 = document.getElementById("music1");
                my_song_1.play();
                playing_song = my_song_1;
                cond = 1;
            }
            if( this.textInputObject.value == "song2"){
                var my_song_2 = document.getElementById("music2");
                if( cond == 1){
                    playing_song.pause();
                    my_song_2.play();
                    playing_song = my_song_2;
                }
                else{
                    cond = 1;
                    playing_song = my_song_2;
            ...
            if( this.textInputObject.value == "stop"){
                if( cond == 1){
                    playing_song.pause();
                    cond = 0;
                }
